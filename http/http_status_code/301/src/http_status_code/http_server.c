...
int accept_loop(int soc){
  ...
  while (1){ /* 無限ループ. */
    ...
    /* 書き込み */
    strcpy(send_buf, "HTTP/1.0 301 Moved Permanently\r\n"); /* send_bufに"HTTP/1.0 301 Moved Permanently\r\n"をコピー. */
    strcat(send_buf, "Location: http://bgstation0.com/classic1/\r\n"); /* send_bufに"Location: http://bgstation0.com/classic1/\r\n"を連結. */
    strcat(send_buf, "\r\n"); /* send_bufに"\r\n"を連結. */
