...
int accept_loop(int soc){
  ...
  while (1){ /* 無限ループ. */
    ...
    strcat(response_header, "Set-Cookie: key1=value1\r\n"); /* response_headerに"Set-Cookie: key1=value1\r\n"を連結. */
    strcat(response_header, "Set-Cookie: key2=value2\r\n"); /* response_headerに"Set-Cookie: key2=value2\r\n"を連結. */
