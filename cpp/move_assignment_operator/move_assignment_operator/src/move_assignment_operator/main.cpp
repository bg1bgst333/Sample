...
int main(void){
  ...
  // メンバのセット.
  obj3.set_profile("Jiro", 18, "Osaka"); // obj3.set_profileで"Jiro", 18, "Osaka"をセット.
  ...
  // さらなるオブジェクトの宣言.
  class_profile obj4; // class_profileオブジェクトobj4

  // メンバのセット.
  obj4.set_profile("Saburo", 16, "Nagoya"); // obj4.set_profileで"Saburo", 16, "Nagoya"をセット.

  // メンバを取得し, 出力.
  std::cout << "obj4.get_name() = " << obj4.get_name() << std::endl; // obj4.get_nameでname_を取得し, 出力.
  std::cout << "obj4.get_age() = " << obj4.get_age() << std::endl; // obj4.get_ageでage_を取得し, 出力.
  std::cout << "obj4.get_address() = " << obj4.get_address() << std::endl; // obj4.get_addressでaddress_を取得し, 出力.

  // 代入
  obj4 = std::move(obj3); // obj4にobj3を代入.(ムーブ代入.)
