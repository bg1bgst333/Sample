...
class MainClass // MainClassクラスの定義
{
    ...
    static void Main()  // Mainメソッドの定義
    {
        ...
        while (reader.Read())
        {
            Console.WriteLine("ID = {0}, Name = {1}, Address = {2}, Age = {3}", reader["ID"], reader["Name"], reader["Address"], reader["Age"]);  // reader["ID"], reader["Name"], reader["Address"], reader["Age"]を出力.
        }
        Console.WriteLine("Read End!");  // "Read End!"と出力.
