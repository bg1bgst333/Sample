...
class MainClass
{
    ...
    static void Main()
    {
        ...
        // 親タスクの実行
        var pt = Task.Factory.StartNew(() => // Task.Factory.StartNew(action, creationOptions)で実行.
        {
        ...
        }, TaskCreationOptions.DenyChildAttach);    // TaskCreationOptions.DenyChildAttachを指定すると, 子のアタッチを禁止する.
