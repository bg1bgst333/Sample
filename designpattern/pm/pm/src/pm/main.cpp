...
int main(){
  ...
  class_custom_presentation_model *custom_presentation_model_ptr = new class_custom_presentation_model(); // class_custom_presentation_modelオブジェクトの生成.
  ...
  // カスタムコントロールにカスタムモデルをセット.
  custom_controller_ptr->set_custom_model(custom_model_ptr); // custom_controller_ptr->set_custom_modelでcustom_model_ptrをセット.
  ...
  delete custom_presentation_model_ptr; // deleteでcustom_presentation_model_ptrを解放.
