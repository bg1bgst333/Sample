...
int _tmain() {
	...
	// GETリクエスト文字列の作成.
	request_tstr = _T("GET /youtube/v3/videos?id=");	// request_tstrに"GET /youtube/v3/videos?id="を格納.
	request_tstr = request_tstr + VIDEO_ID;	// request_tstrにVIDEO_IDを連結.
	request_tstr = request_tstr + _T("&key=");	// request_tstrに"&key="を連結.
	request_tstr = request_tstr + API_KEY;	// request_tstrにAPI_KEYを連結.
	request_tstr = request_tstr + _T("&part=snippet");	// request_tstrに"&part=snippet"を連結.
