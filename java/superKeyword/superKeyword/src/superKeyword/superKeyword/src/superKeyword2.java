// 整数値と文字列を持つクラス
class superKeyword2 {	// superKeyword2クラスの定義
	...
	// メソッドの定義
	// 初期化処理
	superKeyword2() {	// コンストラクタsuperKeyword2()
		i = 0;	// 0をiにセット.
		str = "-";	// "-"をstrにセット.
	}

	// 初期化処理(指定の値をセット.)
	superKeyword2(int i, String str){	// コンストラクタsuperKeyword2(int i, String str).(これも名前が同じで引数が違うのでオーバーロードと言える.)
