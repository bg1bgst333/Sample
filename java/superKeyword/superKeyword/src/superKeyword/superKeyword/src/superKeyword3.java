...
class superKeyword3 extends superKeyword2 {	// superKeyword2クラスを継承したsuperKeyword3クラスの定義.
	...
	// メソッドの定義
	// 初期化処理
	superKeyword3() {	// コンストラクタsuperKeyword3()
		super(0, "-");	// super(superKeyword2のコンストラクタ)で, 0と"-"をセット.
		f = 0;			// fに0をセット.
		b = false;		// bにfalseをセット.
	}
	...
	public void set(int i, String str, float f, boolean b) {	// メソッドset(int i, String str, float f, boolean b)の定義.
		super.set(i, str);	// super.set(superKeyword2のset)で, iとstrをセット.
	...
	public void output() {	// メソッドoutputの定義
		super.output();	// super.output(superKeyword2のoutput)で, iとstrを出力.
