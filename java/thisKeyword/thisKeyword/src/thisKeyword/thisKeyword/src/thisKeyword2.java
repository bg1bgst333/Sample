// 整数値と文字列を持つクラス
class thisKeyword2 {	// thisKeyword2クラスの定義
	...
	// メソッドの定義
	// 初期化処理
	thisKeyword2(){	// コンストラクタthisKeyword2()
		i = 0;	// 0をiにセット.
		str = "-";	// "-"をstrにセット.
	}

	// 初期化処理(指定の値をセット.)
	thisKeyword2(int i, String str){	// コンストラクタthisKeyword2(int i, String str).(これも名前が同じで引数が違うのでオーバーロードと言える.)
