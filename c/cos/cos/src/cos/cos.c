...
int main(void){
  ...
  double val_60 = 1.0 / 2.0; /* val_60を1/2で初期化. */
  ...
  /* 余弦値の計算と出力. */
  printf("cos(0(deg)) = %lf\n", cos(rad_0)); /* 0°のcosを出力. */
  printf("cos(30(deg)) = %lf\n", cos(rad_30)); /* 30°のcosを出力. */
  printf("cos(45(deg)) = %lf\n", cos(rad_45)); /* 45°のcosを出力. */
  printf("cos(60(deg)) = %lf\n", cos(rad_60)); /* 60°のcosを出力. */
  printf("cos(90(deg)) = %lf\n", cos(rad_90)); /* 90°のcosを出力. */
