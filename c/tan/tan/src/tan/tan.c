...
int main(void){
  ...
  /* 正接値の計算と出力. */
  printf("tan(0(deg)) = %lf\n", tan(rad_0)); /* 0°のtanを出力. */
  printf("tan(30(deg)) = %lf\n", tan(rad_30)); /* 30°のtanを出力. */
  printf("tan(45(deg)) = %lf\n", tan(rad_45)); /* 45°のtanを出力. */
  printf("tan(60(deg)) = %lf\n", tan(rad_60)); /* 60°のtanを出力. */
  printf("tan(90(deg)) = %lf\n", tan(rad_90)); /* 90°のtanを出力. */
