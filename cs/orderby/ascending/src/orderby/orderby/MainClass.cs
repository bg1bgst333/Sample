...
class MainClass // MainClassの定義
{
    ...
    static void Main()  // Mainメソッドの定義
    {
        ...
        // LINQで身長が170以上の大きいボディの名前を身長の昇順でソートして取得.
        var result = from p in bodies where p.Height >= 170 orderby p.Height ascending select p.Name; // p.Heightが170以上のp.Nameのリストを身長の昇順でソートしてresultに格納.
