================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: DDX_CBString プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した DDX_CBString には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには DDX_CBString アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
DDX_CBString.h
   ...
   CDDX_CBStringApp アプリケーション クラスを宣言します。

DDX_CBString.cpp
   これは、アプリケーション クラス CDDX_CBStringApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\DDX_CBString.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル DDX_CBString.rc に含まれていま
   す。

res\DDX_CBString.rc2
...
DDX_CBStringDlg.h, DDX_CBStringDlg.cpp - ダイアログ
   これらのファイルは CDDX_CBStringDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な DDX_CBString.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   DDX_CBString.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
