================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: DDX_Check プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した DDX_Check には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには DDX_Check アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
DDX_Check.h
   ...
   CDDX_CheckApp アプリケーション クラスを宣言します。

DDX_Check.cpp
   これは、アプリケーション クラス CDDX_CheckApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\DDX_Check.ico
   ...
   アイコンはメイン リソース ファイル DDX_Check.rc に含まれていま
   す。
...
DDX_CheckDlg.h, DDX_CheckDlg.cpp - ダイアログ
   これらのファイルは CDDX_CheckDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な DDX_Check.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   DDX_Check.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
