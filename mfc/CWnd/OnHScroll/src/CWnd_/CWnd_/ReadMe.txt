================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CWnd_ プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CWnd_ には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CWnd_ アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CWnd_.h
   ...
   CWnd_App アプリケーション クラスを宣言します。

CWnd_.cpp
   これは、アプリケーション クラス CWnd_App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CWnd_.ico
   ...
   アイコンはメイン リソース ファイル CWnd_.rc に含まれていま
   す。
...
CWnd_Dlg.h, CWnd_Dlg.cpp - ダイアログ
   これらのファイルは CWnd_Dlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CWnd_.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CWnd_.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
