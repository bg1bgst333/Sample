================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CWnd プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CWnd には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CWnd アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CWnd.h
   ...
   CWndApp アプリケーション クラスを宣言します。

CWnd.cpp
   これは、アプリケーション クラス CWndApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CWnd.ico
   ...
   アイコンはメイン リソース ファイル CWnd.rc に含まれていま
   す。
...
CWndDlg.h, CWndDlg.cpp - ダイアログ
   これらのファイルは CWndDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CWnd.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CWnd.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
