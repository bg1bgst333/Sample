...
void CWnd_Dlg::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
	// TODO: ここにメッセージ ハンドラ コードを追加するか、既定の処理を呼び出します。
	// 渡されたCScrollBarオブジェクトポインタがNULLの時.
	if (pScrollBar == NULL){	// pScrollBarがNULLの時.
		CDialog::OnVScroll(nSBCode, nPos, pScrollBar);	// 引数をCDialog::OnVScrollに渡して任せる.
		return;	// ここで終了.
	}
	// スクロールバーの位置更新.
