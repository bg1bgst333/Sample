...
void CFrameWnd_::OnItem1_1(){	// メニュー項目Item1_1のコマンドハンドラ
	...
	// ポップアップメニューのポインタを取得.
	CMenu *pPopupMenu1 = pMenu->GetSubMenu(0);	// pMenuの0番目のポップアップメニューのポインタを取得し, pPopupMenu1に格納.

	// ポップアップメニュー項目の追加.
	pPopupMenu1->AppendMenu(MF_ENABLED | MF_STRING, ID_ITEM_1_4, _T("Item1-4(&M)"));	// CMenuのAppendMenuメンバ関数でpPopupMenu1に"Item1-4"を追加.
