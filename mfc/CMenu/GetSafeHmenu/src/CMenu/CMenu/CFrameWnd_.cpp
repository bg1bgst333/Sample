...
void CFrameWnd_::OnItem1_1(){	// メニュー項目Item1_1のコマンドハンドラ
	...
	// メニューハンドルの取得.
	CMenu *pMenu = GetMenu();	// CWnd::GetMenuでCMenuオブジェクトポインタpMenu取得.
	HMENU hMenu = pMenu->GetSafeHmenu();	// CMenu::GetSafeHmenuでメニューハンドルhMenu取得.
	::AppendMenu(hMenu, MF_ENABLED | MF_STRING, 102, _T("Item2"));	// Win32APIのAppendMenuで"Item2"を追加.
	::DrawMenuBar(m_hWnd);	// Win32APIのDrawMenuBarでメニューを再描画.
