================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CStatic プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CStatic には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CStatic アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CStatic.h
   ...
   CStaticApp アプリケーション クラスを宣言します。

CStatic.cpp
   これは、アプリケーション クラス CStaticApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CStatic.ico
   ...
   アイコンはメイン リソース ファイル CStatic.rc に含まれていま
   す。
...
CStaticDlg.h, CStaticDlg.cpp - ダイアログ
   これらのファイルは CStaticDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CStatic.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CStatic.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
