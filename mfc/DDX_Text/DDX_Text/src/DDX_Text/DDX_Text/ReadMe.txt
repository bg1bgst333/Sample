================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: DDX_Text プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した DDX_Text には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには DDX_Text アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
DDX_Text.h
   ...
   CDDX_TextApp アプリケーション クラスを宣言します。

DDX_Text.cpp
   これは、アプリケーション クラス CDDX_TextApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\DDX_Text.ico
   ...
   アイコンはメイン リソース ファイル DDX_Text.rc に含まれていま
   す。
...
DDX_TextDlg.h, DDX_TextDlg.cpp - ダイアログ
   これらのファイルは CDDX_TextDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な DDX_Text.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   DDX_Text.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
