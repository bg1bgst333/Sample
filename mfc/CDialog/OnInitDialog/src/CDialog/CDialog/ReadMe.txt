================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CDialog プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CDialog には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CDialog アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CDialog.h
   ...
   CDialogApp アプリケーション クラスを宣言します。

CDialog.cpp
   これは、アプリケーション クラス CDialogApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CDialog.ico
   ...
   アイコンはメイン リソース ファイル CDialog.rc に含まれていま
   す。
...
CDialogDlg.h, CDialogDlg.cpp - ダイアログ
   これらのファイルは CDialogDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CDialog.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CDialog.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
