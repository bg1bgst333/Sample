================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CProgressCtrl プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CProgressCtrl には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CProgressCtrl アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

CProgressCtrl.vcproj
...
CProgressCtrl.h
   ...
   CProgressCtrlApp アプリケーション クラスを宣言します。

CProgressCtrl.cpp
   これは、アプリケーション クラス CProgressCtrlApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CProgressCtrl.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル CProgressCtrl.rc に含まれていま
   す。

res\CProgressCtrl.rc2
...
CProgressCtrlDlg.h, CProgressCtrlDlg.cpp - ダイアログ
   これらのファイルは CProgressCtrlDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CProgressCtrl.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CProgressCtrl.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
