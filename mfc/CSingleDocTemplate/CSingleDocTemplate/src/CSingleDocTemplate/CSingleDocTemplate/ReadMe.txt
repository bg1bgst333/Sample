================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CSingleDocTemplate プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CSingleDocTemplate には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CSingleDocTemplate アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

CSingleDocTemplate.vcproj
...
CSingleDocTemplate.h
   ...
   CSingleDocTemplateApp アプリケーション クラスを宣言します。

CSingleDocTemplate.cpp
   これは、アプリケーション クラス CSingleDocTemplateApp を含むメイン アプリケー
   ション ソース ファイルです。

CSingleDocTemplate.rc
...
res\CSingleDocTemplate.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル CSingleDocTemplate.rc に含まれていま
   す。

res\CSingleDocTemplate.rc2
...
CSingleDocTemplateDoc.h, CSingleDocTemplateDoc.cpp - ドキュメント
   これらのファイルは CSingleDocTemplateDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CSingleDocTemplateDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

CSingleDocTemplateView.h, CSingleDocTemplateView.cpp - ドキュメントのビュー
   これらのファイルは CSingleDocTemplateView クラスを含みます。
   CSingleDocTemplateView オブジェクトは CSingleDocTemplateDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   CSingleDocTemplate.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
