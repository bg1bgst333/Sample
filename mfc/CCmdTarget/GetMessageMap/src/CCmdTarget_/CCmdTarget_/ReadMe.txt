================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CCmdTarget_ プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CCmdTarget_ には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CCmdTarget_ アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CCmdTarget_.h
   ...
   CCmdTarget_App アプリケーション クラスを宣言します。

CCmdTarget_.cpp
   これは、アプリケーション クラス CCmdTarget_App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CCmdTarget_.ico
   ...
   アイコンはメイン リソース ファイル CCmdTarget_.rc に含まれていま
   す。
...
CCmdTarget_Doc.h, CCmdTarget_Doc.cpp - ドキュメント
   これらのファイルは CCmdTarget_Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CCmdTarget_Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

CCmdTarget_View.h, CCmdTarget_View.cpp - ドキュメントのビュー
   これらのファイルは CCmdTarget_View クラスを含みます。
   CCmdTarget_View オブジェクトは CCmdTarget_Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   CCmdTarget_.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
