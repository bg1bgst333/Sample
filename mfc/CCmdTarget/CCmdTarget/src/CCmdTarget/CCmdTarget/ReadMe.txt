================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CCmdTarget プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CCmdTarget には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CCmdTarget アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CCmdTarget.h
   ...
   CCmdTargetApp アプリケーション クラスを宣言します。

CCmdTarget.cpp
   これは、アプリケーション クラス CCmdTargetApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CCmdTarget.ico
   ...
   アイコンはメイン リソース ファイル CCmdTarget.rc に含まれていま
   す。
...
CCmdTargetDlg.h, CCmdTargetDlg.cpp - ダイアログ
   これらのファイルは CCmdTargetDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CCmdTarget.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CCmdTarget.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
