================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: DDX_Scroll プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した DDX_Scroll には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには DDX_Scroll アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
DDX_Scroll.h
   ...
   CDDX_ScrollApp アプリケーション クラスを宣言します。

DDX_Scroll.cpp
   これは、アプリケーション クラス CDDX_ScrollApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\DDX_Scroll.ico
   ...
   アイコンはメイン リソース ファイル DDX_Scroll.rc に含まれていま
   す。
...
DDX_ScrollDlg.h, DDX_ScrollDlg.cpp - ダイアログ
   これらのファイルは CDDX_ScrollDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な DDX_Scroll.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   DDX_Scroll.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
