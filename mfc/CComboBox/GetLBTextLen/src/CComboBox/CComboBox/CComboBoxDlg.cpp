...
void CComboBoxDlg::OnBnClickedButton2()
{
	...
	TCHAR tszLen[32];	// 長さを文字列に変換したもの.
	_stprintf(tszLen, _T("len = %lu"), len);	// _stprintfで長さを文字列に変換.
	AfxMessageBox(tszLen, MB_OK | MB_ICONASTERISK);	// AfxMessageBoxでtszLenを出力.
}
