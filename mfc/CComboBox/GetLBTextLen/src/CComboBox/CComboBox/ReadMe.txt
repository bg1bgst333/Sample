================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CComboBox プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CComboBox には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CComboBox アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CComboBox.h
   ...
   CComboBoxApp アプリケーション クラスを宣言します。

CComboBox.cpp
   これは、アプリケーション クラス CComboBoxApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CComboBox.ico
   ...
   アイコンはメイン リソース ファイル CComboBox.rc に含まれていま
   す。
...
CComboBoxDlg.h, CComboBoxDlg.cpp - ダイアログ
   これらのファイルは CComboBoxDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CComboBox.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CComboBox.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
