================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CBitmap プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CBitmap には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CBitmap アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CBitmap.h
   ...
   CBitmapApp アプリケーション クラスを宣言します。

CBitmap.cpp
   これは、アプリケーション クラス CBitmapApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CBitmap.ico
   ...
   アイコンはメイン リソース ファイル CBitmap.rc に含まれていま
   す。
...
CBitmapDlg.h, CBitmapDlg.cpp - ダイアログ
   これらのファイルは CBitmapDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CBitmap.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CBitmap.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
