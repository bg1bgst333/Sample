================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CListBox プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CListBox には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CListBox アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CListBox.h
   ...
   CListBoxApp アプリケーション クラスを宣言します。

CListBox.cpp
   これは、アプリケーション クラス CListBoxApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CListBox.ico
   ...
   アイコンはメイン リソース ファイル CListBox.rc に含まれていま
   す。
...
CListBoxDlg.h, CListBoxDlg.cpp - ダイアログ
   これらのファイルは CListBoxDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CListBox.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CListBox.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
