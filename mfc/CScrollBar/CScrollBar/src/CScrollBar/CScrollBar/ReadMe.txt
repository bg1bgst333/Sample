================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CScrollBar プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CScrollBar には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CScrollBar アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CScrollBar.h
   ...
   CScrollBarApp アプリケーション クラスを宣言します。

CScrollBar.cpp
   これは、アプリケーション クラス CScrollBarApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CScrollBar.ico
   ...
   アイコンはメイン リソース ファイル CScrollBar.rc に含まれていま
   す。
...
CScrollBarDlg.h, CScrollBarDlg.cpp - ダイアログ
   これらのファイルは CScrollBarDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CScrollBar.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CScrollBar.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
