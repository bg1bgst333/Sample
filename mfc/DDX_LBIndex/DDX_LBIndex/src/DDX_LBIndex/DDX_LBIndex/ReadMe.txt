================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: DDX_LBIndex プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した DDX_LBIndex には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには DDX_LBIndex アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
DDX_LBIndex.h
   ...
   CDDX_LBIndexApp アプリケーション クラスを宣言します。

DDX_LBIndex.cpp
   これは、アプリケーション クラス CDDX_LBIndexApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\DDX_LBIndex.ico
   ...
   アイコンはメイン リソース ファイル DDX_LBIndex.rc に含まれていま
   す。
...
DDX_LBIndexDlg.h, DDX_LBIndexDlg.cpp - ダイアログ
   これらのファイルは CDDX_LBIndexDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な DDX_LBIndex.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   DDX_LBIndex.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
