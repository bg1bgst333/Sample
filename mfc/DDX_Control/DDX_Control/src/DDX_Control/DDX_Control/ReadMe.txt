================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: DDX_Control プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した DDX_Control には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには DDX_Control アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
DDX_Control.h
   ...
   CDDX_ControlApp アプリケーション クラスを宣言します。

DDX_Control.cpp
   これは、アプリケーション クラス CDDX_ControlApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\DDX_Control.ico
   ...
   アイコンはメイン リソース ファイル DDX_Control.rc に含まれていま
   す。
...
DDX_ControlDlg.h, DDX_ControlDlg.cpp - ダイアログ
   これらのファイルは CDDX_ControlDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な DDX_Control.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   DDX_Control.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
