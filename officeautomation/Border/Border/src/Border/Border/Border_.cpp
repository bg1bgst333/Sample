...
int _tmain(int argc, TCHAR *argv[]) {	// main関数のTCHAR版.
	...
	pBordersA1->put_Weight(Excel::XlBorderWeight::xlThin);	// Excel::CBorders::put_Weightで罫線太さを極細に.
	...
	pBordersB2C3->put_Weight(Excel::XlBorderWeight::xlMedium);	// Excel::CBorders::put_Weightで罫線太さを普通に.
