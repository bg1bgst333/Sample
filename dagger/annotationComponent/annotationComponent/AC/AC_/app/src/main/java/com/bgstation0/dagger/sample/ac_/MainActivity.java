...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coffeeShop = DaggerMainActivity_CoffeeShop.builder().pumpBaseModule2(new PumpBaseModule2()).build();    // PumpBaseModule2に差し替え.
    ...
    // コーヒーメーカー(PumpBaseModule2を指定.)
    @Component(modules = PumpBaseModule2.class)
