...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	HWND hFindWnd;						// FindWindowで見つけたウィンドウのハンドルhFindWnd.

	// ウィンドウ名が"FindWindow"なウィンドウが存在すれば起動しない.
	hFindWnd = FindWindow(NULL, _T("FindWindow"));	// FindWindowでウィンドウ名"FindWindow"なウィンドウを探す.
	if (hFindWnd != NULL){	// 存在する.
		return -3;	// 異常終了(3)
	}
