...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("TBADDBITMAP");						// ウィンドウクラス名"TBADDBITMAP".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("TBADDBITMAP"), _T("TBADDBITMAP"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
				...
				switch (LOWORD(wParam)){	// LOWORD(wParam)で選択されたメニュー項目のIDが取得できるので, その値で判定する.
					...
					case IDM_ZERO:
						...
						// IDM_ZEROブロック
						{
							...
							// "Zero"と表示.
							MessageBox(hwnd, _T("Zero"), _T("TBADDBITMAP"), MB_OK);
					...
					case IDM_ONE:
						...
						// IDM_ONEブロック
						{
							...
							// "One"と表示.
							MessageBox(hwnd, _T("One"), _T("TBADDBITMAP"), MB_OK);
					...
					case IDM_TWO:
						...
						// IDM_TWOブロック
						{
							...
							// "Two"と表示.
							MessageBox(hwnd, _T("Two"), _T("TBADDBITMAP"), MB_OK);
					...
					case IDM_THREE:
						...
						// IDM_THREEブロック
						{
							...
							// "Three"と表示.
							MessageBox(hwnd, _T("Three"), _T("TBADDBITMAP"), MB_OK);
					...
					case ID_FILE_NEW:
						...
						// ID_FILE_NEWブロック
						{
							...
							// "ID_FILE_NEW"と表示.
							MessageBox(hwnd, _T("ID_FILE_NEW"), _T("TBADDBITMAP"), MB_OK);
