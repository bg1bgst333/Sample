...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("CBN_CLOSEUP");						// ウィンドウクラス名"CBN_CLOSEUP".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("CBN_CLOSEUP"), _T("CBN_CLOSEUP"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
