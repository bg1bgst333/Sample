...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("BN_SETFOCUS");						// ウィンドウクラス名"BN_SETFOCUS".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("BN_SETFOCUS"), _T("BN_SETFOCUS"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
							...
							switch (HIWORD(wParam)){
								...
								case BN_SETFOCUS:
									...
									// BN_SETFOCUSブロック.
									{
										...
										// "BN_SETFOCUS"とデバッグ出力.
										OutputDebugString(_T("BN_SETFOCUS\n"));
