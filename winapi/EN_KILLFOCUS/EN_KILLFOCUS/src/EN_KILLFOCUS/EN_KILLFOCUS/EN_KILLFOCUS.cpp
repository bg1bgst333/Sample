...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("EN_KILLFOCUS");						// ウィンドウクラス名"EN_KILLFOCUS".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("EN_KILLFOCUS"), _T("EN_KILLFOCUS"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
							...
							switch (HIWORD(wParam)){
								...
								case EN_SETFOCUS:

									{
										...
										// "ID_EDIT2 EN_SETFOCUS"とデバッグ出力.
										OutputDebugString(_T("ID_EDIT2 EN_SETFOCUS\n"));
								...
								case EN_KILLFOCUS:

									{
										...
										// "ID_EDIT2 EN_KILLFOCUS"とデバッグ出力.
										OutputDebugString(_T("ID_EDIT2 EN_KILLFOCUS\n"));
