...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("TTM_ADDTOOL");						// ウィンドウクラス名"TTM_ADDTOOL".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("TTM_ADDTOOL"), _T("TTM_ADDTOOL"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
				...
				switch (LOWORD(wParam)){	// LOWORD(wParam)で選択されたメニュー項目のIDが取得できるので, その値で判定する.
					...
					case IDM_ZERO:
						...
						// IDM_ZEROブロック
						{
							...
							// "Zero"と表示.
							MessageBox(hwnd, _T("Zero"), _T("TTM_ADDTOOL"), MB_OK);
					...
					case IDM_ONE:
						...
						// IDM_ONEブロック
						{
							...
							// "One"と表示.
							MessageBox(hwnd, _T("One"), _T("TTM_ADDTOOL"), MB_OK);
					...
					case IDM_TWO:
						...
						// IDM_TWOブロック
						{
							...
							// "Two"と表示.
							MessageBox(hwnd, _T("Two"), _T("TTM_ADDTOOL"), MB_OK);
					...
					case IDM_THREE:
						...
						// IDM_THREEブロック
						{
							...
							// "Three"と表示.
							MessageBox(hwnd, _T("Three"), _T("TTM_ADDTOOL"), MB_OK);
					...
					case ID_FILE_NEW:
						...
						// ID_FILE_NEWブロック
						{
							...
							// "ID_FILE_NEW"と表示.
							MessageBox(hwnd, _T("ID_FILE_NEW"), _T("TTM_ADDTOOL"), MB_OK);
					...
					case ID_FOLDER_PARENT:
						...
						// ID_FOLDER_PARENTブロック
						{
							...
							MessageBox(hwnd, _T("ID_FOLDER_PARENT"), _T("TTM_ADDTOOL"), MB_OK);
					...
					case ID_FILE_OPEN:
						...
						// ID_FILE_OPENブロック
						{
							...
							// "ID_FILE_OPEN"と表示.
							MessageBox(hwnd, _T("ID_FILE_OPEN"), _T("TTM_ADDTOOL"), MB_OK);
