...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("CBN_SELENDCANCEL");					// ウィンドウクラス名"CBN_SELENDCANCEL".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("CBN_SELENDCANCEL"), _T("CBN_SELENDCANCEL"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
	...
	switch (uMsg){	// uMsgごとに処理振り分け.
		...
		case WM_CREATE:
			...
			// WM_CREATEブロック
			{
				...
				// ID_COMBOBOX1の作成.
				hComboBox1 = CreateWindow(WC_COMBOBOX, _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER | WS_TABSTOP | CBS_DROPDOWN, 50, 50, 120, 360, hwnd, (HMENU)ID_COMBOBOX1, lpCS->hInstance, NULL);	// CreateWindowでID_COMBOBOX1を作成.
				if (hComboBox1 == NULL){
					return -1;
				}
