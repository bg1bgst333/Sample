...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("EN_MAXTEXT");						// ウィンドウクラス名"EN_MAXTEXT".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("EN_MAXTEXT"), _T("EN_MAXTEXT"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
	...
	switch (uMsg){	// uMsgごとに処理振り分け.
		...
		case WM_CREATE:
			...
			// WM_CREATEブロック
			{
				...
				// ID_EDIT1の作成.
				hEdit1 = CreateWindow(WC_EDIT, _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 50, 50, 200, 25, hwnd, (HMENU)ID_EDIT1, lpCS->hInstance, NULL);	// CreateWindowでID_EDIT1を作成.
				if (hEdit1 == NULL){
					return -1;
				}

				// 5文字制限.
				SendMessage(hEdit1, EM_SETLIMITTEXT, 5, 0);	// EM_SETLIMITTEXTで5文字に制限.
							...
							switch (HIWORD(wParam)){
								...
								case EN_KILLFOCUS:

									{
										...
										// "ID_EDIT1 EN_KILLFOCUS"とデバッグ出力.
										OutputDebugString(_T("ID_EDIT1 EN_KILLFOCUS\n"));
								...
								case EN_MAXTEXT:

									{
										...
										// "ID_EDIT1 EN_MAXTEXT"とデバッグ出力.
										OutputDebugString(_T("ID_EDIT1 EN_MAXTEXT\n"));
								...
								case EN_HSCROLL:

									{
										...
										// "ID_EDIT1 EN_HSCROLL"とデバッグ出力.
										OutputDebugString(_T("ID_EDIT1 EN_HSCROLL\n"));
								...
								case EN_VSCROLL:

									{
										...
										// "ID_EDIT1 EN_VSCROLL"とデバッグ出力.
										OutputDebugString(_T("ID_EDIT1 EN_VSCROLL\n"));
