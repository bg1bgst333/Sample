...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("CBN_EDITCHANGE");					// ウィンドウクラス名"CBN_EDITCHANGE".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("CBN_EDITCHANGE"), _T("CBN_EDITCHANGE"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
							...
							switch (HIWORD(wParam)){
								...
								case CBN_KILLFOCUS:

									{
										...
										// "ID_COMBOBOX1 CBN_KILLFOCUS"とデバッグ出力.
										OutputDebugString(_T("ID_COMBOBOX1 CBN_KILLFOCUS\n"));
								...
								case CBN_EDITCHANGE:

									{
										...
										// 3文字を超えたら3文字にする.
										TCHAR tszInputText[256] = {0};
										HWND hComboBox1 = GetDlgItem(hwnd, ID_COMBOBOX1);
										GetWindowText(hComboBox1, tszInputText, 256);
										tszInputText[3] = _T('\0');
										SetWindowText(hComboBox1, tszInputText);
										TCHAR tszTemp[512] = {0};
										_stprintf(tszTemp, _T("ID_COMBOBOX1 CBN_EDITCHANGE: %s\n"), tszInputText);
								...
								case CBN_EDITUPDATE:

									{
										...
										// "ID_COMBOBOX1 CBN_EDITUPDATE: "と入力文字列をデバッグ出力.
										TCHAR tszInputText[256] = {0};
										HWND hComboBox1 = GetDlgItem(hwnd, ID_COMBOBOX1);
										GetWindowText(hComboBox1, tszInputText, 256);
										TCHAR tszTemp[512] = {0};
										_stprintf(tszTemp, _T("ID_COMBOBOX1 CBN_EDITUPDATE: %s\n"), tszInputText);
										OutputDebugString(tszTemp);
							...
							switch (HIWORD(wParam)){
								...
								case CBN_KILLFOCUS:

									{
										...
										// "ID_COMBOBOX2 CBN_KILLFOCUS"とデバッグ出力.
										OutputDebugString(_T("ID_COMBOBOX2 CBN_KILLFOCUS\n"));
								...
								case CBN_EDITCHANGE:

									{
										...
										// 3文字を超えたら3文字にする.
										TCHAR tszInputText[256] = {0};
										HWND hComboBox2 = GetDlgItem(hwnd, ID_COMBOBOX2);
										GetWindowText(hComboBox2, tszInputText, 256);
										tszInputText[3] = _T('\0');
										SetWindowText(hComboBox2, tszInputText);
										TCHAR tszTemp[512] = {0};
										_stprintf(tszTemp, _T("ID_COMBOBOX2 CBN_EDITCHANGE: %s\n"), tszInputText);
										OutputDebugString(tszTemp);
								...
								case CBN_EDITUPDATE:

									{
										...
										// "ID_COMBOBOX2 CBN_EDITUPDATE: "と入力文字列をデバッグ出力.
										TCHAR tszInputText[256] = {0};
										HWND hComboBox2 = GetDlgItem(hwnd, ID_COMBOBOX2);
										GetWindowText(hComboBox2, tszInputText, 256);
										TCHAR tszTemp[512] = {0};
										_stprintf(tszTemp, _T("ID_COMBOBOX2 CBN_EDITUPDATE: %s\n"), tszInputText);
										OutputDebugString(tszTemp);
