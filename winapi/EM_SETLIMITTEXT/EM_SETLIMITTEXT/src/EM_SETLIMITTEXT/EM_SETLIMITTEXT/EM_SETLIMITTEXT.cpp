...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("EM_SETLIMITTEXT");					// ウィンドウクラス名"EM_SETLIMITTEXT".
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("EM_SETLIMITTEXT"), _T("EM_SETLIMITTEXT"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウ作成.
	if (hWnd == NULL){
