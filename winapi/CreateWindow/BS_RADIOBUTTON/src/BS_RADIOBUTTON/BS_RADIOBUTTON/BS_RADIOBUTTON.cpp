...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	// ウィンドウクラスの設定
	wc.lpszClassName = _T("BS_RADIOBUTTON");					// ウィンドウクラス名は"BS_RADIOBUTTON".
	...
	if (!RegisterClass(&wc)){	// RegisterClassでウィンドウクラスを登録し, 0が返ったらエラー.
		...
		// エラー処理
		MessageBox(NULL, _T("RegisterClass failed!"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONHAND);	// MessageBoxで"RegisterClass failed!"とエラーメッセージを表示.
		return -1;	// 異常終了(1)
	...
	// ウィンドウの作成
	hWnd = CreateWindow(_T("BS_RADIOBUTTON"), tszWindowName, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowで, 上で登録した"BS_RADIOBUTTON"ウィンドウクラスのウィンドウを作成.
	if (hWnd == NULL){	// ウィンドウの作成に失敗したとき.

		// エラー処理
		MessageBox(NULL, _T("CreateWindow failed!"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONHAND);	// MessageBoxで"CreateWindow failed!"とエラーメッセージを表示.
		return -2;	// 異常終了(2)
	...
	switch (uMsg){	// switch-casa文でuMsgの値ごとに処理を振り分ける.
		...
		case WM_CREATE:		// ウィンドウの作成が開始された時.(uMsgがWM_CREATEの時.)
			...
			// WM_CREATEブロック
			{
				...
				// ラジオボタン1の作成.
				hRadio1 = CreateWindow(WC_BUTTON, _T("RadioButton1"), WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON, 50, 120, 120, 30, hwnd, (HMENU)ID_RADIO1, lpCS->hInstance, NULL);	// CreateWindowのWC_BUTTONとBS_RADIOBUTTONでラジオボタン"RadioButton1"を作成.
				...
				// ラジオボタン2の作成.
				hRadio2 = CreateWindow(WC_BUTTON, _T("RadioButton2"), WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON, 170, 120, 120, 30, hwnd, (HMENU)ID_RADIO2, lpCS->hInstance, NULL);	// CreateWindowのWC_BUTTONとBS_RADIOBUTTONでラジオボタン"RadioButton2"を作成.
				...
				// ラジオボタン3の作成.
				hRadio3 = CreateWindow(WC_BUTTON, _T("RadioButton3"), WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON, 290, 120, 120, 30, hwnd, (HMENU)ID_RADIO3, lpCS->hInstance, NULL);	// CreateWindowのWC_BUTTONとBS_RADIOBUTTONでラジオボタン"RadioButton3"を作成.
				...
				switch (LOWORD(wParam)){	// LOWORD(wParam)で選択されたメニュー項目, またはコントロールのIDが取得できるので, その値で判定する.
					...
					case ID_ITEM_1_2:
						...
						// ID_ITEM_1_2ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("Item1-2"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"Item1-2"と表示.
					...
					case ID_ITEM_1_3:
						...
						// ID_ITEM_1_3ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("Item1-3"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"Item1-3"と表示.
					...
					case ID_ITEM_2_1:
						...
						// ID_ITEM_2_1ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("Item2-1"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"Item2-1"と表示.
					...
					case ID_ITEM_2_2:
						...
						// ID_ITEM_2_2ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("Item2-2"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"Item2-2"と表示.
					...
					case ID_ITEM_2_3:
						...
						// ID_ITEM_2_3ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("Item2-3"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"Item2-3"と表示.
					...
					case ID_ITEM_3_1:
						...
						// ID_ITEM_3_1ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("Item3-1"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"Item3-1"と表示.
					...
					case ID_ITEM_3_2:
						...
						// ID_ITEM_3_2ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("Item3-2"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"Item3-2"と表示.
					...
					case ID_ITEM_3_3:
						...
						// ID_ITEM_3_3ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("Item3-3"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"Item3-3"と表示.
					...
					case ID_BUTTON1:
						...
						// ID_BUTTON1ブロック
						{
							...
							// エディットコントロールのリソースIDを取得.
							hEdit = GetDlgItem(hwnd, ID_EDIT1);	// GetDlgItemでID_EDIT1のハンドルを取得.

							// "Button1 Clicked!"をセット.
							SetWindowText(hEdit, _T("Button1 Clicked!"));	// SetWindowTextでエディットコントロールhEditに"Button1 Clicked!"をセット.
					...
					case ID_CHECK1:
						...
						// ID_CHECK1ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("CheckBox1 Cliked!"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"CheckBox1 Cliked!"と表示.
					...
					case ID_RADIO1:
						...
						// ID_RADIO1ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("RadioButton1 Clicked!"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"RadioButton1 Clicked!"と表示.
					...
					case ID_RADIO2:
						...
						// ID_RADIO2ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("RadioButton2 Clicked!"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"RadioButton2 Clicked!"と表示.
					...
					case ID_RADIO3:
						...
						// ID_RADIO3ブロック
						{
							...
							// メッセージボックスを表示.
							MessageBox(NULL, _T("RadioButton3 Clicked!"), _T("BS_RADIOBUTTON"), MB_OK | MB_ICONASTERISK);	// MessageBoxで"RadioButton3 Clicked!"と表示.
