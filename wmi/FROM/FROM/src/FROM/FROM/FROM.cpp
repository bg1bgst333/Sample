...
int _tmain(int argc, TCHAR *argv[]){	// main関数のTCHAR版.
	...
	BSTR strQuery = SysAllocString(L"SELECT * FROM Win32_USBController WHERE Name = \"USB 大容量記憶装置\"");	// SysAllocStringでstrQueryを"SELECT * FROM Win32_USBController WHERE Name = \"USB 大容量記憶装置\""で初期化.
