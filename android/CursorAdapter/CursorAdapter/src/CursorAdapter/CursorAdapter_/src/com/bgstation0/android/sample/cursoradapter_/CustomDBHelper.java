...
public class CustomDBHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE = "create table custom ( _id integer primary key, name string, age integer);";	// CREATE_TABLE文.
	...
	public void onCreate(SQLiteDatabase db){
		...
		try{	// tryで囲む.
			...
			Log.e("CursorAdapter_", ex.toString());	// ex.toStringをLogに出力.
		}
	}
