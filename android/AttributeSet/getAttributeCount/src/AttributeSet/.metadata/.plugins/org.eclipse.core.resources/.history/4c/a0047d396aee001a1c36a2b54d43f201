...
public class CustomView extends View {
	...
	public CustomView(Context context, AttributeSet attrs){
		...
		// ログを残す.
		Log.d(TAG, "attrs.getAttributeValue(0) = " + attrs.getAttributeValue(0));	// 0番目の属性値をログ出力.
		Log.d(TAG, "attrs.getAttributeValue(1) = " + attrs.getAttributeValue(1));	// 1番目の属性値をログ出力.
		Log.d(TAG, "attrs.getAttributeValue(2) = " + attrs.getAttributeValue(2));	// 2番目の属性値をログ出力.
		Log.d(TAG, "attrs.getAttributeValue(3) = " + attrs.getAttributeValue(3));	// 3番目の属性値をログ出力.
