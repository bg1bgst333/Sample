...
public class MainActivity extends FragmentActivity{	// support.v4のFragmentActivityにする必要がある.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomFragmentStatePagerAdapter cfspa = new CustomFragmentStatePagerAdapter(getSupportFragmentManager());	// cfspaを生成.
        viewPager.setAdapter(cfspa);	// viewPagerにcfspaをセット.
